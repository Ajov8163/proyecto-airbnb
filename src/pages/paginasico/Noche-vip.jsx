    ...
    <div>
      ...
      <div className="flex  flex-col mt-6 items-center ">
        ...
        <img
          ...
          src={
            "https://a0.muscache.com/im/pictures/hosting/Hosting-U3RheVN1cHBseUxpc3Rpbmc6MTEzMTA4NzY0ODgzNzUzNjQzNw%3D%3D/original/cda19e4c-ae11-47b1-831b-a29f94ab76dc.png?im_w=1200&im_q=highq"
          }
        />
            ...
            <div className="flex gap-5 py-5 border-b items-center">
              <div>
                <img
                  ...
                  src="https://a0.muscache.com/im/pictures/user/User-571409085/original/05c90606-bfef-4378-8ffa-9b6065022ca4.jpeg?im_w=240"
                />
              </div>
              <div className="flex flex-col">
                <h1 className="font-semibold text-xl ">Anfitríon:  Kevin Hart</h1>
                <p className="opacity-70 text-s">Comediante</p>
              </div>
            </div>
          ...
          <div className="w-[45%] flex justify-end ">
            <div className="flex border justify-center w-[400px] h-[180px] items-center  rounded-xl shadow-lg  mt-7 ">
              <div className="flex justify-center items-center flex-col">
                <h1 className="font-semibold text-2xl mb-3">Abre en julio</h1>
                <button className="boder bg-rose-500 text-white py-4 px-24 rounded-xl font-semibold">
                  Ávisame
                </button>
              </div>
            </div>
