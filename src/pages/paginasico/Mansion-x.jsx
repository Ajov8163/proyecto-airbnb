  ...
  return (
    <div>
      ...
      <div className="flex  flex-col mt-6 items-center ">
        <div className="flex justify-between w-[1030px]  items-center  mb-8">
          <div>
        ...
        <img
          ...
          src={
            "https://a0.muscache.com/im/pictures/hosting/Hosting-U3RheVN1cHBseUxpc3Rpbmc6MTEzMTg2NzMzNDc0MDk1Nzg4NA%3D%3D/original/b676fc8d-8250-4df0-a7cb-728b0486e371.jpeg?im_w=960&im_q=highq"
          }
        />
        <div className="flex w-2/3 mb-20">
          ...
          <div className="py-5 border-b">
              ...
              New Castle, Nueva York, Estados Unidos
              </h1>
              <p className="opacity-70 text-xl">
              8 huéspedes4 habitaciones5 camas2,5 baños
              </p>
            </div>
            <div className="flex gap-5 py-5 border-b items-center">
              <div>
                <img
                  ...
                  src="https://a0.muscache.com/im/pictures/user/User-570274313/original/d7c84454-58ca-47a3-8436-75ecca56cb0e.jpeg?im_w=240"
                />
              </div>
              <div className="flex flex-col">
                <h1 className="font-semibold text-xl ">Anfitríon: Jubilee</h1>
                <p className="opacity-70 text-s">Superanfitrión, obviamente</p>
              </div>
            </div>
          ...
          <div className="w-[45%] flex justify-end ">
            <div className="flex border justify-center w-[400px] h-[180px] items-center  rounded-xl shadow-lg  mt-7 ">
              <div className="flex justify-center items-center flex-col">
                ...
                <button className="boder bg-gray-400 text-white py-4 px-24 rounded-xl font-semibold">
                 Solicitar
                </button>
              </div>
            </div>
