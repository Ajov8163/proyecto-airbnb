    ...
    <div>
      ...
      <div className="flex  flex-col mt-6 items-center ">
        ...
        <img
          ...
          src={
            "https://a0.muscache.com/im/pictures/hosting/Hosting-U3RheVN1cHBseUxpc3Rpbmc6MTEzMTA4OTQ5ODA0MDcwMTE4Mw%3D%3D/original/4f7a276e-9995-4b32-bda6-300de0619b25.png?im_w=1200&im_q=highq"
          }
        />
          ...
          <div className="w-[55%]">
            ...
            <div className="flex gap-5 py-5 border-b items-center">
              ...
              <div className="flex flex-col">
                <h1 className="font-semibold text-xl ">Anfitríon:  Wendy And Lisa</h1>
                <p className="opacity-70 text-s">Miembros de The Revolution</p>
              </div>
            </div>
          ...
          <div className="w-[45%] flex justify-end ">
            <div className="flex border justify-center w-[400px] h-[180px] items-center  rounded-xl shadow-lg  mt-7 ">
              <div className="flex justify-center items-center flex-col">
                <h1 className="font-semibold text-2xl mb-3">Abre en agosto</h1>
