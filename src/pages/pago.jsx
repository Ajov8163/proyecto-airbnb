...
const Pago = () => {
  ...
  return (
    <div>
      ...
      <div seccion1 className="px-10 border-b">
        <div className="w-36 ">
          <img src="https://download.logo.wine/logo/Airbnb/Airbnb-Logo.wine.png" />
        </div>
      </div>
      <div>
        <div seccion2 className="flex items-end gap-4 py-16 px-22 mx-32">
          <div>
            <svg
          ...
          <div className=" w-full ">
            <h1 className="text-4xl font-semibold">Solicita reservar</h1>
          </div>
        </div>
      </div>
      <div seccion3 className="mx-32 px-24 flex mb-28">
        <div seccion31 className="w-1/2 ">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="border py-2 rounded-xl flex justify-between px-5">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h1 className="text-lg">Tarjeta de crédito o débito</h1>
                  </div>
                </div>
                <div>
                  <svg
              ...
              <div tarjeta className="border flex flex-col rounded-xl text-lg ">
                ...
                <div className="flex w-full">
                  <div className="w-full py-4 px-3 border-r">
                    <input type="text" placeholder="Caducidad" />
                  </div>
                  <div className="w-full py-4 px-3">
                    <input type="text" placeholder="Código CCV" />
                  </div>
                </div>
              </div>
              <div className="border rounded-xl py-4 px-3 ">
                <input type="" placeholder="Código postal" />
              </div>
         ...
         <button type="submit" onClick={abre} class="text-white bg-rose-500 hover:bg-rose-600 hover:shadow-xl font-medium rounded-lg text-lg px-5 py-2.5 ">Solicita reservar </button>
        
        </div>
        <div seccion32 className="w-1/2 flex justify-end h-96 ">
          <div className="border p-5 w-4/12 rounded-lg fixed  ">
